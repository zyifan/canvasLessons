(function () {
    ...
    function game() {
        ...
        expMusic.playbackRate = 2.0; //两倍播放速度，playbackRate设置视频、音频播放速度
        ...
        function action(e) {
            ...
            if (playing) { //如果游戏进行中，每点击一次填充一颗子弹
                ...
                var dist;
                if (gameOver) {
                    // 变量dist,它的作用是判断鼠标的点击位置。
                    //开始按钮位于星球的中间，游戏gameover后重新开始的图标也位于星球的中心，dist就是判断鼠标是否在按钮内
        ...
        function _asteroids() {
            ...
            for (var i = 0; i < asteroids.length; i++) {
                if (!asteroids[i].destroyed) {
                    ...
                    //实际坐标 asteroids[i].height / asteroids[i].size 实际高度
